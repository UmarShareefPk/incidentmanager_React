                ...
                />
                 ...
                 <h6 className="heading indigo-text darken-4 left-align">Add Comment</h6>
                    <div className="input-field"> 
                       <textarea id="comment" className="materialize-textarea" value={newComment} onChange= {(e)=>setNewComment(e.target.value)}></textarea> 
                    ...
                    <div className="file-field input-field">
                      ...
                      <div className="file-path-wrapper">
                        <input className="file-path validate" ref={newCommentFilesRef} type="text" placeholder="Upload upto 3 files" />
                      </div>
                    </div>
